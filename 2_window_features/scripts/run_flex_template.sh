...
--parameters input-subscription=projects/long-axle-412512/topics/example-window-pipeline \
--parameters output-subscription=projects/long-axle-412512/topics/example-output-window-pipeline
